        ...
        GoogleApiClient.OnConnectionFailedListener, LocationListener
{
    ...
    Animation slideUpAnimation; ImageView imageView;

    private static View view;
    private Boolean b;
    private static final LatLng AJMERI_GATE = new LatLng(26.9176473,75.8144671);
   ...
   private  RadioGroup rgModes;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        Toast.makeText(getActivity(), "onCrete() in one", Toast.LENGTH_LONG).show();
        Log.i("call:", "onCrete()");
...
//        Toast.makeText(getActivity(), "setUserVisibleHint()", Toast.LENGTH_LONG).show();
        ...
        if (isUserVisible && view != null)
        {
            ...
            if(count==1)
            {                                           //means fragment is visible once
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
       ...
       // Toast.makeText(getActivity(), "onCreteview() in one", Toast.LENGTH_LONG).show();
        Log.i("call:", "onCreteView()");
...
//Toast.makeText(getActivity(), "onResume in one", Toast.LENGTH_LONG).show();
        Log.i("call:", "onResume()");
    ...
    public void onAttach(Context context) {
       ...
       // Toast.makeText(getActivity(), "onAtach in one", Toast.LENGTH_LONG).show();
        Log.i("call:", "onAtach()");
    ...
    public void onDetach() {
        super.onDetach();
      //  Toast.makeText(getActivity(), "onDetach in one", Toast.LENGTH_LONG).show();
        Log.i("call:", "onDetach()");
