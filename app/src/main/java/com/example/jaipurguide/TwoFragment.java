        ...
        GoogleApiClient.OnConnectionFailedListener, LocationListener
{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
       ...
       // Toast.makeText(getActivity(), "onCreate2() in two", Toast.LENGTH_LONG).show();
        Log.i("call:", "onCreate2()");
...
//        Toast.makeText(getActivity(), "setUserVisibleHint()", Toast.LENGTH_LONG).show();
    ...
    {
       // Toast.makeText(getActivity(), "onCreateView() in two", Toast.LENGTH_LONG).show();
